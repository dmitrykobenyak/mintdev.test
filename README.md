...
- 250 unique mindfulness cards across three categories (Think, Do, Feel)
...
// With parameters
const counter = window.t('ui.currentIndex', { current: 1, total: 250 }); // "1 / 250" or "1 из 250"
```
...
4. **Card content**: All 250 cards translated
